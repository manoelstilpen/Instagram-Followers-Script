...
followers_icon = chrome.find_element_by_xpath("//a[contains(@href,'/manoelstilpen/followers/')]")
...
following_icon = chrome.find_element_by_xpath("//a[contains(@href,'/manoelstilpen/following/')]")
